...
public class Coverages extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public AddCoverage addCoverage(java.lang.String id, com.example.pedro.myapplication.backend1.coverages.model.Coverage content) throws java.io.IOException {
    AddCoverage result = new AddCoverage(id, content);
    initialize(result);
    return result;
  }
  ...
  public class AddCoverage extends CoveragesRequest<Void> {
    ...
    private static final String REST_PATH = "addCoverage/{id}";
     ...
     * @since 1.13
     */
    protected AddCoverage(java.lang.String id, com.example.pedro.myapplication.backend1.coverages.model.Coverage content) {
    ...
    public AddCoverage setId(java.lang.String id) {
      this.id = id;
      return this;
    }
